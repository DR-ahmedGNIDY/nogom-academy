...
const createUser = async (req, res, next) => {
  ...
  // super_admin can create supervisor, academy_admin, admin, security or coach; default to academy_admin
  const allowedRoles = ['supervisor', 'academy_admin', 'admin', 'security', 'coach'];
