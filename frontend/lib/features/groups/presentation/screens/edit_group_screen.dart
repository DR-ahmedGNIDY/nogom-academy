...
class _EditGroupScreenState extends ConsumerState<EditGroupScreen> {
  ...
  void initState() {
    ...
    _ageGroupController =
        TextEditingController(text: widget.group.ageGroup ?? '');
    _capacityController = TextEditingController(
        text: widget.group.capacity?.toString() ?? '');
    _coachController =
        TextEditingController(text: widget.group.coachId ?? '');
    _selectedSport = widget.group.sportId;
  }
  ...
  Future<void> _submit() async {
    ...
    final error = await ref.read(groupsProvider.notifier).updateGroup(
          ...
          coachId: _coachController.text.trim(),
